...
## Purpose
Frontend web app for SurgiCare, the PF-G1 surgery scheduling project. It provides MVP screens, authentication UX, surgery views, and the planning demo UI.
...
## MVP Planning Notes
- `/mvp/cirugias` is the real demo screen for planning from Back data.
...
- Prefer real Back data in MVP routes; keep mock data isolated to legacy/mock screens unless explicitly requested.
