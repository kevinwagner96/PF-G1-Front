...
export default function PacientesList() {
  ...
  const remove = (id: string) => { if (confirm('¿Desea dar de baja este paciente del mock?')) { setItems(items.filter(p => p.id !== id)); setMessage('Paciente dado de baja correctamente.') } }
