...
export default function PacientesList() {
  ...
  return <div className="space-y-6">
    ...
    <ConfirmActionDialog open={Boolean(deleteId)} onOpenChange={open => { if (!open) setDeleteId(null) }} title="Dar de baja al paciente" description="Se quitará de la lista simulada durante esta sesión." confirmLabel="Dar de baja" onConfirm={remove}/>
  </div>
}
